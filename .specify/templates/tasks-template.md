...
- [ ] T004 [P] Define performance budgets and validation method for critical flows
...
- [ ] T011 Define shared UX states (loading, empty, success, error) patterns for this feature
...
- [ ] T014 [P] [US1] Unit test for core business logic in tests/unit/test\_[name].py
...
- [ ] T021 [US1] Validate UX states and accessibility expectations for this story
- [ ] T022 [US1] Verify performance budget for this story and record results
...
- [ ] T025 [P] [US2] Unit test for core business logic in tests/unit/test\_[name].py
...
- [ ] T030 [US2] Validate UX states and accessibility expectations for this story
- [ ] T031 [US2] Verify performance budget for this story and record results
...
- [ ] T034 [P] [US3] Unit test for core business logic in tests/unit/test\_[name].py
...
- [ ] T038 [US3] Validate UX states and accessibility expectations for this story
- [ ] T039 [US3] Verify performance budget for this story and record results
...
- [ ] TXXX [P] Additional unit and integration coverage for cross-story risks in tests/
...
Task: "Unit test for core business logic in tests/unit/test_[name].py"
